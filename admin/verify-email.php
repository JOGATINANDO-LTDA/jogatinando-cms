...
if ($token === '') {
    ...
    echo '<!DOCTYPE html><html lang="pt-BR"><head><meta charset="UTF-8"><title>Link inválido</title>';
...
if (!$user) {
    ...
    echo '<!DOCTYPE html><html lang="pt-BR"><head><meta charset="UTF-8"><title>Token inválido</title>';
    echo '<style>body{font-family:sans-serif;background:#111;color:#eee;display:flex;align-items:center;justify-content:center;min-height:100vh;margin:0}';
    echo '.card{background:#1a1a2e;border:1px solid #c9a84c;border-radius:12px;padding:40px;max-width:400px;text-align:center}';
...
if ($stmt->rowCount() > 0) {
    echo '<!DOCTYPE html><html lang="pt-BR"><head><meta charset="UTF-8"><title>Email confirmado!</title>';
    echo '<style>body{font-family:sans-serif;background:#111;color:#eee;display:flex;align-items:center;justify-content:center;min-height:100vh;margin:0}';
    echo '.card{background:#1a1a2e;border:1px solid #c9a84c;border-radius:12px;padding:40px;max-width:400px;text-align:center}';
